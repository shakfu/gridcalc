...
- **`TEXTSPLIT` with `pad_with`** — current implementation flattens 2D splits and ignores `pad_with`. Once 2D Vecs are real this becomes meaningful.
